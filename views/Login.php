...
<form class="Formed" action="../controllers/Controller.php" method="POST">
  ...
  <a href="../controllers/Controller.php?todo=AfficherRegister" style="color: white;">You dont have an account ? Register</a>

</form>
<script>
          // Sélection de l'élément de la checkbox et du champ de mot de passe
  const checkbox = document.querySelector('.containerEye input[type="checkbox"]');
  const passwordField = document.getElementById('password');

  // Fonction pour basculer entre le type de champ de mot de passe et le texte brut
  ...
  // Écouteur d'événement de clic sur la checkbox
